class VacanciesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      ...
      puts @vacancy.errors.full_messages
    end
  end
  ...
  def update
    respond_to do |format|
      if @vacancy.update(vacancy_params)
        format.html { redirect_to company_vacancies_path, notice: 'Vacancy was successfully updated.' }
  ...
  def destroy
    @vacancy.destroy
    respond_to do |format|
      format.html { redirect_to company_vacancies_path, notice: 'Vacancy was successfully destroyed.' }
  ...
  private
    ...
    def vacancy_params
      params.require(:vacancy).permit(:title, :company_id)
    end
end
